(function () {
  ...
  var paths = ['/', '/product/', '/security/', '/docs/', '/pricing/', '/trust/', '/changelog/', '/company/', '/contact/', '/releases/', '/license/', '/payment/', '/payment/register/', '/payment/success/', '/terms/', '/privacy/', '/refund/'];
