(function () {
  ...
  function headerMarkup() {
    return '<a class="skip-link" href="#main" data-common="skip">' + t('skip') + '</a>' +
      ...
      '<a class="brand" href="/" aria-label="ODRE PQC home"><span class="brand-mark" aria-hidden="true"></span><span>ODRE PQC</span></a>' +
      '<nav class="desktop-nav" aria-label="Primary">' + groups.slice(0, 3).map(desktopGroup).join('') + '<a class="nav-direct" href="/pricing/" data-common="pricing">' + t('pricing') + '</a>' + groups.slice(3).map(function(group,index){ return desktopGroup(group,index+3); }).join('') + '</nav>' +
      ...
      '<button class="mobile-toggle" id="mobile-toggle" type="button" aria-expanded="false" aria-controls="mobile-drawer" aria-label="Menu"><span></span></button></div></div></header>' +
      '<div class="mobile-overlay" id="mobile-overlay"></div><aside class="mobile-drawer" id="mobile-drawer" aria-label="Mobile navigation" aria-hidden="true"><nav class="mobile-nav">' +
  ...
  function footerMarkup() {
    return '<footer class="site-footer"><div class="container footer-main"><div class="footer-brand"><a class="brand" href="/"><span class="brand-mark" aria-hidden="true"></span><span>ODRE PQC</span></a><p data-common="footerText">' + t('footerText') + '</p></div>' +
      ...
      footerColumn('company', [['about','/company/'],['enterprise','/enterprise/'],['contact','/contact/'],['activation','/payment/register/']]) +
