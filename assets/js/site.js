(function () {
  ...
  function headerMarkup() {
    return '<a class="skip-link" href="#main" data-common="skip">' + t('skip') + '</a>' +
      ...
      '<nav class="desktop-nav" data-primary-nav aria-label="' + t('primaryNav') + '">' + groups.slice(0, 3).map(desktopGroup).join('') + '<a class="nav-direct" href="/pricing/" data-common="pricing">' + t('pricing') + '</a>' + groups.slice(3, 5).map(function(group,index){ return desktopGroup(group,index+3); }).join('') + '<a class="nav-direct" href="/changelog/" data-common="developmentHistory">' + t('developmentHistory') + '</a>' + groups.slice(5).map(function(group,index){ return desktopGroup(group,index+5); }).join('') + '</nav>' +
      ...
      groups.slice(0, 3).map(mobileGroup).join('') + '<a class="mobile-direct" href="/pricing/" data-common="pricing">' + t('pricing') + '</a>' + groups.slice(3, 5).map(function(group,index){ return mobileGroup(group,index+3); }).join('') + '<a class="mobile-direct" href="/changelog/" data-common="developmentHistory">' + t('developmentHistory') + '</a>' + groups.slice(5).map(function(group,index){ return mobileGroup(group,index+5); }).join('') +
  ...
  function footerMarkup() {
    return '<footer class="site-footer"><div class="container footer-main"><div class="footer-brand"><a class="brand" href="/"><span class="brand-mark" aria-hidden="true"></span><span>ODRE PQC</span></a><p data-common="footerText">' + t('footerText') + '</p></div>' +
      ...
      footerColumn('resources', [['docs','/docs/'],['quickstart','/docs/#quick-start'],['releases','/releases/'],['developmentHistory','/changelog/'],['faq','/docs/#faq']]) +
  ...
  if (!document.querySelector('script[data-odre-analytics]')) {
    ...
    analytics.src = '/assets/js/analytics.js?v=development-history-20260917';
